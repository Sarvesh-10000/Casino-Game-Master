...
int main()
{
    cout<<"             Welcome to Casino Master\n";
    cout<<"            **************************\n";
    cout<<"             Rules to be followed     \n";
	cout<<"             1.You deposite Your money\n"; 
	cout<<"             2.Bet in any of number between 1 to 10\n";
	cout<<"             If you guess the correct number 10 times the bitting amount will be credited\n";
	cout<<"             If you loose the Bitting amount will be debited\n";
	cout<<"            \n";
